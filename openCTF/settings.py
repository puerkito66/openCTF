"""
Django settings for openCTF project.
...
SECRET_KEY = "5*v+rn&h77jpf8fvhz9#0g5+#7$ei%zpp7fam9qd$&)gd$@gy$"
...
WSGI_APPLICATION = "openCTF.wsgi.application"
